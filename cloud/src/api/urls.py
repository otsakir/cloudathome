...
from .views import (
    ProxyMappingListView, WebProxyMappingCreateView, TcpProxyMappingCreateView,
    ProxyMappingDestroyAPIView, ProxyInstanceAPIView,
...
urlpatterns = [
    ...
    path('api/homes/<slug:home_slug>/proxy-mappings/', ProxyMappingListView.as_view(), name='proxy-mappings'),
    path('api/homes/<slug:home_slug>/proxy-mappings/http/', WebProxyMappingCreateView.as_view(), name='create-proxy-mapping'),
